...
const Login: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Vérifier après login si l'utilisateur est super admin
            // Le user sera mis à jour dans le contexte après le login
            setTimeout(() => {
                ...
                if (savedUser) {
                    try {
                        ...
                        if (userData.is_super_admin) {
                            ...
                            // L'utilisateur n'est pas super admin, déconnexion et affichage erreur
                            logout();
                            alert('Accès refusé. Vous devez être Super Admin pour accéder à cet espace.');
                        }
                    } catch {
                        navigate('/superadmin');
                    }
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8">
                    <div className="flex items-center justify-center mb-6">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 text-sm">Accès administrateur système</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <Input
                            ...
                            placeholder="superadmin@ikivio.com"
                            icon={Mail}
