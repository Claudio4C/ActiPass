...
import { LogOut, Menu, Sparkles, User, CreditCard, ArrowLeftRight, Bell, Sun, Moon } from 'lucide-react';
                    ...
                    <div className="flex justify-between items-center h-16">
                        <div className="flex items-center">
                            ...
                            <span
                                className={`ml-4 px-3 py-1 text-sm font-medium rounded-full transition-colors ${
                                    isClubMode ? 'bg-blue-100 text-blue-800' : 'bg-purple-100 text-purple-800'
                                }`}
                            >
                                {badgeText}
                            </span>
                            {isClubMode && activeOrganisation ? (
                                <Link
                                    to="/club/members"
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="hidden sm:flex flex-col items-end leading-tight">
                                <span className="text-sm text-gray-700 dark:text-slate-200">Bonjour, {user?.firstName ?? 'membre'}</span>
                                <span className="text-xs text-gray-500 dark:text-slate-400">Gérer mon compte</span>
                            </div>
