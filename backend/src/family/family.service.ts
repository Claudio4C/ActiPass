...
export class FamilyService {
  ...
  /**
   * Créer un compte enfant et le lier au parent connecté.
   * L'enfant n'a pas de mot de passe — il se connecte via son parent.
   */
  ...
  /**
   * Lister tous les enfants du parent connecté.
   */
  ...
  /**
   * Mettre à jour les infos d'un enfant (vérifie que le parent est bien son tuteur).
   */
  ...
  /**
   * Supprimer le lien parent/enfant (ne supprime pas le compte enfant).
   */
  ...
  /**
   * Inscrire un enfant dans une organisation (crée un membership au nom de l'enfant).
   */
  ...
  /**
   * Tableau de bord consolidé du parent :
   * tous les enfants + leurs prochains événements.
   */
